...
import dyly.bloomu.edu.gardenplannerapp.Adapters.WorkHistoryNoteListAdapter;
...
public class BedWorkHistoryActivity extends Fragment
{
    ...
    {
        View rootView = inflater.inflate(R.layout.activity_bed_work_history, container, false);

        //add custom header to list view.
        View header = getActivity().getLayoutInflater().inflate(R.layout.custom_notes_header, null);
        final ListView noteList = (ListView) rootView.findViewById(R.id.workHistoryList);
        ...
        WorkHistoryNoteListAdapter adapter = new WorkHistoryNoteListAdapter(getContext(),
